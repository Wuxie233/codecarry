...
import dev.wuxie233.codecarry.data.api.AgentErrorPayloadDto
import dev.wuxie233.codecarry.data.api.AgentFallbackPayloadDto
import dev.wuxie233.codecarry.data.api.AgentRetryPayloadDto
import dev.wuxie233.codecarry.data.api.AgentTurnStartPayloadDto
import dev.wuxie233.codecarry.data.api.AwaitingCommandPayloadDto
import dev.wuxie233.codecarry.data.api.AwaitingSkipPayloadDto
import dev.wuxie233.codecarry.data.api.ErrorPayloadDto
import dev.wuxie233.codecarry.data.api.MessageDeltaPayloadDto
import dev.wuxie233.codecarry.data.api.MessageEndPayloadDto
import dev.wuxie233.codecarry.data.api.ModeratorSynthesisPayloadDto
import dev.wuxie233.codecarry.data.api.PiApi
import dev.wuxie233.codecarry.data.api.PiCommandParticipantDto
import dev.wuxie233.codecarry.data.api.PiCommandRequest
...
import dev.wuxie233.codecarry.data.api.PiRoundLimitsDto
import dev.wuxie233.codecarry.data.api.PiRoundtableDto
import dev.wuxie233.codecarry.data.api.PiSpeakerPolicyDto
import dev.wuxie233.codecarry.data.api.PiRosterSummaryDto
import dev.wuxie233.codecarry.data.api.RoundEndPayloadDto
import dev.wuxie233.codecarry.data.api.RoundStartPayloadDto
import dev.wuxie233.codecarry.data.api.RoundtableSseEvent
import dev.wuxie233.codecarry.data.api.resolvedId
...
import dev.wuxie233.codecarry.domain.transport.PiAcceptedDelta
import dev.wuxie233.codecarry.domain.transport.PiAuthor
import dev.wuxie233.codecarry.domain.transport.PiEventEnvelope
import dev.wuxie233.codecarry.domain.transport.PiMessageIntegrity
import dev.wuxie233.codecarry.domain.transport.PiModelRef
import dev.wuxie233.codecarry.domain.transport.PiRoundLimits
import dev.wuxie233.codecarry.domain.transport.PiRoundtableRoom
import dev.wuxie233.codecarry.domain.transport.PiSpeakerPolicy
...
import dev.wuxie233.codecarry.domain.transport.TransportModelSelection
import dev.wuxie233.codecarry.domain.transport.TransportRoom
import dev.wuxie233.codecarry.domain.transport.TransportRoomScope

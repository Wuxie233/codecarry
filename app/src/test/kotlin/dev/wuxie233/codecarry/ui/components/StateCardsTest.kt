...
class StateCardsTest {
    ...
    fun stateCardComposableSymbols_areExported() {
        val exportedNames = Class
            .forName("dev.wuxie233.codecarry.ui.components.StateCardsKt")
            .declaredMethods
            .map { it.name }
            .toSet()
    ...
    fun errorStateCard_definesRetryActionText() {
        val source = java.io.File("src/main/kotlin/dev/wuxie233/codecarry/ui/components/StateCards.kt").readText()

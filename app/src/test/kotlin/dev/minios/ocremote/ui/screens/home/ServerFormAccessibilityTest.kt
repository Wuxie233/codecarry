...
class ServerFormAccessibilityTest {
    ...
    fun serverDialog_textFieldsHaveExplicitContentDescriptionsDerivedFromLabels() {
        val source = File("src/main/kotlin/dev/minios/ocremote/ui/screens/home/ServerDialog.kt").readText()
    ...
    fun settingsLocalServerFieldsHaveExplicitContentDescriptionsDerivedFromLabels() {
        val source = File("src/main/kotlin/dev/minios/ocremote/ui/screens/settings/SettingsScreen.kt").readText()
    ...
    fun connectionErrorsExposePersistentInlineRetryAffordance() {
        ...
        val providersSource = File("src/main/kotlin/dev/minios/ocremote/ui/screens/server/ServerProvidersScreen.kt").readText()
